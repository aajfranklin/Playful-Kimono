  ...
  return(
    <main>
      <section id="terms">
        ...
        <p>To contact us, please email <a href="mailto:hello@playfulkimono.com">hello@playfulkimono.com</a></p>
        ...
        <p>If you know or suspect that anyone other than you knows your user identification code or password, you must promptly notify us at <a href="mailto:hello@playfulkimono.com">hello@playfulkimono.com</a>.</p>
        ...
        <p>If you wish to complain about content uploaded by other users, please contact us on <a href="mailto:hello@playfulkimono.com">hello@playfulkimono.com</a>.</p>
        ...
        <p>If you wish to link to or make any use of content on our site other than that set out above, please contact <a href="mailto:hello@playfulkimono.com">hello@playfulkimono.com</a>.</p>
